...
\begin{itemize}
    ...
    \item
    The CNEC was conducted by the National Bureau of Statistics (NBS) of China in 2004, and was designed to cover the entire population of Chinese firms in that year. The firm-level data from the CNEC are not available to the general public and therefore not uploaded as part of our data files. For data access, please contact the NBS of China at \url{wgsjsys@stats.gov.cn}. For more information on the CNEC, please visit the dedicated page maintained by NBS at the following url: \url{http://www.stats.gov.cn/ztjc/zdtjgz/zgjjpc}. The url was retrieved on November 15th, 2019 and may vary in the future.
