...
\end{itemize}
Because we cannot post the NGSPS and CNEC publicly, the readers will not be able to run some of the files. Tables \ref{tab:navi_main} and \ref{tab:navi_appendix} list respectively which part of each file depends on which datasets and generates which result; the datasets are referenced using the above two-letter acronyms.
