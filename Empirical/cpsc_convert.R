...
# -------------------------------------------------------------------------
PathIn <- "./Data"
File <- paste(PathIn, "keynum.dta", sep = "/")

KEYFIRM <- read.dta(File)
...
comment(KEYFIRM$wastewater_g) <- "Total Amount of Wastewater Generated (in ton)"
comment(KEYFIRM$wastewater_e) <- "Total Amount of Wastewater Discharged (in ton)"
comment(KEYFIRM$water_u) <- "Total Water Used = Acquired + Recycled (in ton)"
comment(KEYFIRM$water_r) <- "Total Water Recycled (in ton)"
comment(KEYFIRM$cod_g) <- "Total Amount of Chemical Oxygen Demand Generated (in ton)"
comment(KEYFIRM$cod_e) <- "Total Amount of Chemical Oxygen Demand Discharged (in ton)"
...
comment(KEYFIRM$phe_g) <- "Total Amount of Volatile Phenol Generated (in ton)"
comment(KEYFIRM$phe_e) <- "Total Amount of Volatile Phenol Discharged (in ton)"
comment(KEYFIRM$bod_g) <- "Total Amount of Biochemical Oxygen Demand Generated (in ton)"
comment(KEYFIRM$bod_e) <- "Total Amount of Biochemical Oxygen Demand Discharged (in ton)"
...
comment(KEYFIRM$chr6_g) <- "Total Amount of Hexavalent Chrome Generated (in kg)"
comment(KEYFIRM$chr6_e) <- "Total Amount of Hexavalent Chrome Discharged (in kg)"
comment(KEYFIRM$dm1_inv) <- "Total Investment of Wastewater Disposal Equipment 1 (RMB 10000)"
comment(KEYFIRM$dm1_quant) <- "Designed Disposal Capacity of Equip 1 (in ton)"
comment(KEYFIRM$dm1_oprcost) <- "Total Operating Costs of Equip 1 (RMB 10000)"
comment(KEYFIRM$dm1_hours) <- "Total Operating Hours of Equip 1"
comment(KEYFIRM$dm1_elec) <- "Total Amount of Electricity Consumed Equip 1 (10000kw/h)"
comment(KEYFIRM$dm1_ef) <- "Efficiency of Equip 1 (in %)"
comment(KEYFIRM$dm1_code) <- "Code for Disposal Method of Equip 1"
comment(KEYFIRM$dm2_inv) <- "Total Investment of Wastewater Disposal Equipment 2 (RMB 10000)"
comment(KEYFIRM$dm2_quant) <- "Designed Disposal Capacity of Equip 2 (in ton)"
comment(KEYFIRM$dm2_oprcost) <- "Total Operating Costs of Equip 2 (RMB 10000)"
comment(KEYFIRM$dm2_hours) <- "Total Operating Hours of Equip 2"
comment(KEYFIRM$dm2_elec) <- "Total Amount of Electricity Consumed Equip 2 (10000kw/h)"
comment(KEYFIRM$dm2_ef) <- "Efficiency of Equip 2 (in %)"
comment(KEYFIRM$dm2_code) <- "Code for Disposal Method of Equip 2"
comment(KEYFIRM$dm3_inv) <- "Total Investment of Wastewater Disposal Equipment 3 (RMB 10000)"
comment(KEYFIRM$dm3_quant) <- "Designed Disposal Capacity of Equip 3 (in ton)"
comment(KEYFIRM$dm3_oprcost) <- "Total Operating Costs of Equip 3 (RMB 10000)"
comment(KEYFIRM$dm3_hours) <- "Total Operating Hours of Equip 3"
comment(KEYFIRM$dm3_elec) <- "Total Amount of Electricity Consumed Equip 3 (10000kw/h)"
...
comment(REGFIRM$wastewater_g) <- "Total Amount of Wastewater Generated (in ton)"
comment(REGFIRM$wastewater_e) <- "Total Amount of Wastewater Discharged (in ton)"
comment(REGFIRM$water_u) <- "Total Water Used = Acquired + Recycled (in ton)"
comment(REGFIRM$water_r) <- "Total Water Recycled (in ton)"
comment(REGFIRM$cod_g) <- "Total Amount of Chemical Oxygen Demand Generated (in ton)"
comment(REGFIRM$cod_e) <- "Total Amount of Chemical Oxygen Demand Discharged (in ton)"
...
comment(REGFIRM$phe_g) <- "Total Amount of Volatile Phenol Generated (in ton)"
comment(REGFIRM$phe_e) <- "Total Amount of Volatile Phenol Discharged (in ton)"
comment(REGFIRM$bod_g) <- "Total Amount of Biochemical Oxygen Demand Generated (in ton)"
comment(REGFIRM$bod_e) <- "Total Amount of Biochemical Oxygen Demand Discharged (in ton)"
...
comment(REGFIRM$dm1_inv) <- "Total Investment of Wastewater Disposal Equipment 1 (RMB 10000)"
comment(REGFIRM$dm1_quant) <- "Designed Disposal Capacity of Equip 1 (in ton)"
comment(REGFIRM$dm1_oprcost) <- "Total Operating Costs of Equip 1 (RMB 10000)"
comment(REGFIRM$dm1_elec) <- "Total Amount of Electricity Consumed Equip 1 (10000kw/h)"
...
comment(ALLFIRM$wastewater_g) <- "Total Amount of Wastewater Generated (in ton)"
comment(ALLFIRM$wastewater_e) <- "Total Amount of Wastewater Discharged (in ton)"
comment(ALLFIRM$water_u) <- "Total Water Used = Acquired + Recycled (in ton)"
comment(ALLFIRM$water_r) <- "Total Water Recycled (in ton)"
comment(ALLFIRM$cod_g) <- "Total Amount of Chemical Oxygen Demand Generated (in ton)"
comment(ALLFIRM$cod_e) <- "Total Amount of Chemical Oxygen Demand Discharged (in ton)"
...
comment(ALLFIRM$phe_g) <- "Total Amount of Volatile Phenol Generated (in ton)"
comment(ALLFIRM$phe_e) <- "Total Amount of Volatile Phenol Discharged (in ton)"
comment(ALLFIRM$bod_g) <- "Total Amount of Biochemical Oxygen Demand Generated (in ton)"
comment(ALLFIRM$bod_e) <- "Total Amount of Biochemical Oxygen Demand Discharged (in ton)"
...
comment(ALLFIRM$chr6_g) <- "Total Amount of Hexavalent Chrome Generated (in kg)"
comment(ALLFIRM$chr6_e) <- "Total Amount of Hexavalent Chrome Discharged (in kg)"
comment(ALLFIRM$dm1_inv) <- "Total Investment of Wastewater Disposal Equipment 1 (RMB 10000)"
comment(ALLFIRM$dm1_quant) <- "Designed Disposal Capacity of Equip 1 (in ton)"
comment(ALLFIRM$dm1_oprcost) <- "Total Operating Costs of Equip 1 (RMB 10000)"
comment(ALLFIRM$dm1_hours) <- "Total Operating Hours of Equip 1"
comment(ALLFIRM$dm1_elec) <- "Total Amount of Electricity Consumed Equip 1 (10000kw/h)"
comment(ALLFIRM$dm1_ef) <- "Efficiency of Equip 1 (in %)"
comment(ALLFIRM$dm1_code) <- "Code for Disposal Method of Equip 1"
comment(ALLFIRM$dm2_inv) <- "Total Investment of Wastewater Disposal Equipment 2 (RMB 10000)"
comment(ALLFIRM$dm2_quant) <- "Designed Disposal Capacity of Equip 2 (in ton)"
comment(ALLFIRM$dm2_oprcost) <- "Total Operating Costs of Equip 2 (RMB 10000)"
comment(ALLFIRM$dm2_hours) <- "Total Operating Hours of Equip 2"
comment(ALLFIRM$dm2_elec) <- "Total Amount of Electricity Consumed Equip 2 (10000kw/h)"
comment(ALLFIRM$dm2_ef) <- "Efficiency of Equip 2 (in %)"
comment(ALLFIRM$dm2_code) <- "Code for Disposal Method of Equip 2"
comment(ALLFIRM$dm3_inv) <- "Total Investment of Wastewater Disposal Equipment 3 (RMB 10000)"
comment(ALLFIRM$dm3_quant) <- "Designed Disposal Capacity of Equip 3 (in ton)"
comment(ALLFIRM$dm3_oprcost) <- "Total Operating Costs of Equip 3 (RMB 10000)"
comment(ALLFIRM$dm3_hours) <- "Total Operating Hours of Equip 3"
comment(ALLFIRM$dm3_elec) <- "Total Amount of Electricity Consumed Equip 3 (10000kw/h)"
